...
/*new berocket_admin_notices(array(
    ...
    'image'  => array(
        'global' => 'https://berocket.com/images/logo-2.png', //image URL from other site. Image will be copied to uploads folder if it possible
...
if( ! class_exists( 'berocket_admin_notices' ) ) {
    ...
    class berocket_admin_notices {
        ...
        public static $default_notice_options = array(
                ...
                'repeatcount'   => 1,
                'image'         => array(
                    'global'    => 'https://berocket.com/images/logo-2.png'
                ),
            );
